        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        IsKhadamatMashiniPersonnel = c.Boolean(nullable: false),
                        TelDakheli = c.String(maxLength: 30),
                        TelMostaghim = c.String(maxLength: 50),
                        Mobile = c.String(maxLength: 11, fixedLength: true),
                        Email = c.String(),
                        ProvinceId = c.Int(),
                        SematId = c.Int(),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Shakhes = c.Int(nullable: false),
                        Name = c.String(nullable: false, maxLength: 50),
                        CityCenter = c.String(maxLength: 25),
